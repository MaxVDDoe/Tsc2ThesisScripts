...
MiniscopeVideo = "S:\Data\Miniscope Behaviour Combo\SC\SC_Test\My_V4_Miniscope\0.avi";
...
OutputPath = "S:\Behaviour Miniscope Combo";
...
parfor i = 1:VideoNumFrames
    ...
    frame = rgb2gray(read(MiniscopeVideo,i));
...
%% Place Roi
disp("Place ROI in the video")
FrameMiniscope = read(MiniscopeVideo,1);
Mask = RoiPlacer(FrameMiniscope);
imshow(Mask)
